...
const newsRepository = new Repository();
  ...
  router.get('/', async function (req, res) {
    res.render('news.hbs', {news: await newsRepository.getAll(), page: "news"});
  });
  
  router.get('/:title', async function (req, res) {
    res.render('selectNews.hbs', {content: await newsRepository.getByTitle(req.params["title"]), page: "news"});
  });
